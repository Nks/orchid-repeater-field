<script type="text/html" id="{{ $template ?? null }}">
    <div class="card repeater-item" data-sort="@{{block_key}}">
        <div class="card-header">
            <h5 class="actions">
                <svg class="action card-handle icon-size-fullscreen" data-parent-container-key="@{{name}}" xmlns="http://www.w3.org/2000/svg" version="1.1" width="1em" height="1em" viewBox="0 0 32 32" role="img" fill="currentColor" componentname="orchid-icon">
