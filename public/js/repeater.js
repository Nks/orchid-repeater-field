  ...
  _createClass(_default, [{
    ...
    value: function fetchFields() {
      ...
      axios.post(this.data.get('url'), {
        ...
        r.data.results.forEach(function (v, k) {
          if (self.options.max === null || k < self.options.max) {
            var content = v.join('', v);
    ...
    value: function initMinRequiredBlock() {
      ...
      var blocksCount = this.blocksTarget.querySelectorAll('.repeater-item').length;
    ...
    value: function addBlock(currentBlock) {
      ...
      axios.post(this.data.get('url'), {
        ...
        r.data.results.forEach(function (v, k) {
          var content = v.join('', v),
              compiledTemplate = _this3.template({
            content: content,
            block_key: key,
            block_count: key + 1
          });
          ...
          if (currentBlock != null) {
            ...
            _this3.blocksTarget.insertAdjacentHTML('beforeend', compiledTemplate);
          }
    ...
    key: "sort",
    value: function sort() {
      var repeater_field_name = this.data.get('name'),
      ...
      if (this.hasRepeaterBlockCountTarget) {
        this.repeaterBlockCountTargets.forEach(function (v, k) {
          v.innerHTML = k + 1;
        });
      }
    }
...
_defineProperty(_default, "targets", ["template", "blocks", "content", "repeaterBlockCount", "addBlockButton"]);
...
__webpack_require__(/*! /Users/nks/Projects/laravel/tailgateguys.test/packages/nakukryskin/orchid-repeater-field/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/nks/Projects/laravel/tailgateguys.test/packages/nakukryskin/orchid-repeater-field/resources/sass/app.scss */"./resources/sass/app.scss");
